...
def encrypt_image(image_path, seed, output_path):
...
def decrypt_image(image_path, seed, output_path):
    img = Image.open(image_path)
...
def main():
    print("*********************************************************************************")
    print(" ")
    print("  Welcome to the Cybersecurity Image Encryption and Decryption Tool!")
    print(" ")
    print("*********************************************************************************")
    while True:
        ...
        if choice == 'q':
            ...
            seed = int(input("Enter the secret key value for encryption: "))
            output_path = input("Enter the path to save the encrypted image: ")
            encrypt_image(image_path, seed, output_path)
            ...
            seed = int(input("Enter the secret key value for decryption: "))
            output_path = input("Enter the path to save the decrypted image: ")
            decrypt_image(image_path, seed, output_path)
